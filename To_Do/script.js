...
const displayTasks = () => {
    ...
    taskItem.classList.add('bg-blue-200', 'p-2', 'rounded-lg','flex','justify-between', 'm-4');
    ...
    doneButton.classList.add('mr-4', 'text-green-900');
    ...
    updateButton.classList.add('mr-4', 'text-blue-500');
...
const displayCompletedTasks = () => {
    ...
    completedTasks.forEach((task, index) => {
        ...
        undoButton.classList.add('mr-4', 'text-blue-600');
        ...
        deleteButton.href = '#';
        deleteButton.textContent = 'delete';
        deleteButton.classList.add('mr-4', 'text-red-500');
